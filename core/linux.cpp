...
namespace env {
	...
	const char title[] = "Diary";
	// Make sure this is unique
	const char id[] = "com.example.diary";
}
...
int main(int argc, char **argv) {
	...
	execlp("node", "node", "usr/bin/backend/index.js", std::to_string(forthPipe[0]).c_str(), std::to_string(backPipe[1]).c_str(), nullptr);
	return 0;
}